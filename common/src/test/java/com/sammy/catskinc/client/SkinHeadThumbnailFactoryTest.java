...
class SkinHeadThumbnailFactoryTest {
    ...
    void createsIsometricHeadThumbnailWithDistinctTopFrontAndSideFaces() {
        ...
        try {
            ...
            try {
                int topPixel = thumbnail.getPixel(14, 8);
                int frontPixel = thumbnail.getPixel(16, 18);
                int sidePixel = thumbnail.getPixel(26, 18);

                assertEquals(0, thumbnail.getPixel(1, 1), "background should stay transparent");
