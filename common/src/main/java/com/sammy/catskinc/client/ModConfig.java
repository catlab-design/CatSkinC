...
public final class ModConfig {
    ...
    public static void init(File gameDir) {
        configFile = new File(gameDir, "config/catskinc.json");
        load();
    }
    ...
    public boolean isDebugForceMyopia() {
        return debugForceMyopia;
    }

    public void setDebugForceMyopia(boolean enabled) {
        this.debugForceMyopia = enabled;
    }
