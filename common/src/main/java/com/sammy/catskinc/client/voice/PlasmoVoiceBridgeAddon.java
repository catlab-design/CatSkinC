package com.sammy.catskinc.client.voice;

import com.sammy.catskinc.client.ModLog;
import com.sammy.catskinc.client.VoiceActivityTracker;
...
@Addon(id = "catskinc", name = "CatSkinC Voice Bridge", scope = AddonLoaderScope.CLIENT, version = "2.0.2", authors = {
        "Team CatLab Design" })
