...
public final class SettingsScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor drawContext, int mouseX, int mouseY, float delta) {
        ...
        drawContext.text(this.font, Component.literal(titleStr), scaledTitleX, scaledTitleY, -1);
        ...
        if (subtitleY != -999) {
            ...
            drawContext.text(this.font, Component.literal(subtitleStr), scaledDescX, scaledDescY, -3552823);
            drawContext.pose().popMatrix();
        }
        ...
        drawContext.text(this.font, Component.literal("Client Settings"), this.panelX + 10, this.panelY + 6, -1381654);
        ...
        for (String category : categories) {
            ...
            drawContext.text(this.font, Component.literal((showArrowDown ? "v " : "^ ") + category), this.panelX + 15, y + 4, -1);
            y += 18;
            ...
            if (showArrowDown) {
                for (SettingItem item : categorySettings) {
                    if (item.key.equals("catskinCloudIp")) {
                        ...
                        drawContext.text(this.font, Component.literal(item.label), this.panelX + 25, y + 4, -1);
    ...
    private void drawToggleSettingRow(GuiGraphicsExtractor drawContext, int mouseX, int mouseY, int y, String label, String value, int labelX, int rightOffset, 
                                      Runnable onToggle, Runnable onReset) {
        // Label
        drawContext.text(this.font, Component.literal(label), labelX, y + 4, -1);
    ...
    private void drawRowButton(GuiGraphicsExtractor drawContext, int mouseX, int mouseY, int x, int y, int w, int h, String text) {
        ...
        drawContext.text(this.font, Component.literal(text), x + (w - textW) / 2, y + 4, -1);
    }
